...
export async function createEditCabin(newCabin, id) {
  // If image is a File (new upload), upload and use new path. Otherwise, keep the existing URL.
  let imagePath = newCabin.image;
  let imageName;
  let shouldUpload = false;

  if (newCabin.image && typeof newCabin.image !== 'string' && newCabin.image.name) {
